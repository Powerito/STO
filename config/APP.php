<?php
	...
	----------*/
	const COMPANY="Data System's AlekIsa";
	...
	const FACEBOOK="https://www.facebook.com/dsa.eza";
	const INSTAGRAM="https://instagram.com/dsa.eza?igshid=OGQ5ZDc2ODk2ZA==";
	const YOUTUBE="";
	const TIKTOK="https://www.tiktok.com/@dsa.eza";


	/*----------  Direccion - Address  ----------*/
	const COUNTRY="Honduras";
	const ADDRESS="La Esperanza, Honduras, Centro América";
