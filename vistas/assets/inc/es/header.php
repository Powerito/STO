<header class="header full-box" style="background-color: #FFA500;">
    <div class="header-brand full-box">
        <a href="<?php echo SERVERURL; ?>index/">
            <img src="<?php echo SERVERURL; ?>vistas/assets/img/milogo.png" alt="<?php echo COMPANY; ?>" class="img-fluid">
        </a>
    </div>
