    ...
    <div class="full-box nav-lateral-content scroll">
        ...
        <nav class="full-box nav-lateral-menu">
            <ul>
                ...
                <li>
                    <a href="<?php echo SERVERURL.DASHBOARD; ?>/registration/"><i class="fas fa-user fa-fw"></i> &nbsp; Nuevo Mayorista</a>
                </li>
                ...
                <!--<li>
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/sale/"><i class="fas fa-file-invoice-dollar fa-fw"></i> &nbsp; Ventas realizadas</a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD; ?>/order/"><i class="fas fa-truck-loading fa-fw"></i> &nbsp; Pedidos pendientes</a>
                        </li>
                        <li>
